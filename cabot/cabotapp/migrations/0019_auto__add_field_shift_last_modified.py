...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shift.last_modified'
        db.add_column(u'cabotapp_shift', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 11, 28, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shift.last_modified'
        db.delete_column(u'cabotapp_shift', 'last_modified')
