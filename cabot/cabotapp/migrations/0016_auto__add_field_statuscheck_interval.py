...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatusCheck.interval'
        db.add_column(u'cabotapp_statuscheck', 'interval',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatusCheck.interval'
        db.delete_column(u'cabotapp_statuscheck', 'interval')
