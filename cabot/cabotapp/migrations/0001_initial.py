...
def add_custom_check_plugins_models(base_operations):
    if os.environ.get('CABOT_CUSTOM_CHECK_PLUGINS'):
        plugins = os.environ.get('CABOT_CUSTOM_CHECK_PLUGINS').split(',')
...
full_operations = add_custom_check_plugins_models(base_operations)
