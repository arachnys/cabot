...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HipchatInstance'
        db.create_table(u'cabotapp_hipchatinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('server_url', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('api_v2_key', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'cabotapp', ['HipchatInstance'])

        # Adding field 'Instance.hipchat_instance'
        db.add_column(u'cabotapp_instance', 'hipchat_instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cabotapp.HipchatInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Instance.hipchat_room_id'
        db.add_column(u'cabotapp_instance', 'hipchat_room_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.hipchat_instance'
        db.add_column(u'cabotapp_service', 'hipchat_instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cabotapp.HipchatInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.hipchat_room_id'
        db.add_column(u'cabotapp_service', 'hipchat_room_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'HipchatInstance'
        db.delete_table(u'cabotapp_hipchatinstance')

        # Deleting field 'Instance.hipchat_instance'
        db.delete_column(u'cabotapp_instance', 'hipchat_instance_id')

        # Deleting field 'Instance.hipchat_room_id'
        db.delete_column(u'cabotapp_instance', 'hipchat_room_id')

        # Deleting field 'Service.hipchat_instance'
        db.delete_column(u'cabotapp_service', 'hipchat_instance_id')

        # Deleting field 'Service.hipchat_room_id'
        db.delete_column(u'cabotapp_service', 'hipchat_room_id')
