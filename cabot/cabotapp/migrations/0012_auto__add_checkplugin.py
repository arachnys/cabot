...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'cabotapp', ['CheckPlugin'])


    def backwards(self, orm):
        # Deleting model 'CheckPlugin'
        db.delete_table(u'cabotapp_checkplugin')
    ...
    models = {
        ...
        u'cabotapp.checkplugin': {
            'Meta': {'ordering': "['name']", 'object_name': 'CheckPlugin'},
            ...
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'polymorphic_cabotapp.checkplugin_set'", 'null': 'True', 'to': u"orm['contenttypes.ContentType']"})
        },
        u'cabotapp.instance': {
