...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StatusCheck.http_data'
        db.add_column(u'cabotapp_statuscheck', 'http_data',
                      self.gf('yamlfield.fields.YAMLField')(default=None, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StatusCheck.http_data'
        db.delete_column(u'cabotapp_statuscheck', 'http_data')
    ...
    models = {
        ...
        u'cabotapp.statuscheck': {
            ...
            'header_match': ('yamlfield.fields.YAMLField', [], {'default': 'None', 'null': 'True'}),
            'http_data': ('yamlfield.fields.YAMLField', [], {'default': 'None', 'null': 'True'}),
