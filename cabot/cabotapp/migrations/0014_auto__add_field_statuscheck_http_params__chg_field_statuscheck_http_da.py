...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StatusCheck.http_data'
        db.alter_column(u'cabotapp_statuscheck', 'http_data', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'StatusCheck.header_match'
        db.alter_column(u'cabotapp_statuscheck', 'header_match', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'StatusCheck.http_data'
        db.alter_column(u'cabotapp_statuscheck', 'http_data', self.gf('yamlfield.fields.YAMLField')(null=True))

        # Changing field 'StatusCheck.header_match'
        db.alter_column(u'cabotapp_statuscheck', 'header_match', self.gf('yamlfield.fields.YAMLField')(null=True))
    ...
    models = {
        ...
        u'cabotapp.statuscheck': {
            ...
            'header_match': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
            'http_data': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
            'http_method': ('django.db.models.fields.CharField', [], {'default': "'GET'", 'max_length': '10'}),
            'http_params': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
