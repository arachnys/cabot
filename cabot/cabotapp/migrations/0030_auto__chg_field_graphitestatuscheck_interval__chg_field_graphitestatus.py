...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GraphiteStatusCheck.interval'
        db.alter_column(u'cabotapp_graphitestatuscheck', 'interval', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'GraphiteStatusCheck.expected_num_hosts'
        db.alter_column(u'cabotapp_graphitestatuscheck', 'expected_num_hosts', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'GraphiteStatusCheck.expected_num_metrics'
        db.alter_column(u'cabotapp_graphitestatuscheck', 'expected_num_metrics', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'HttpStatusCheck.timeout'
        db.alter_column(u'cabotapp_httpstatuscheck', 'timeout', self.gf('cabot.cabotapp.fields.PositiveIntegerMaxField')(null=True))

        # Changing field 'StatusCheck.retries'
        db.alter_column(u'cabotapp_statuscheck', 'retries', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'StatusCheck.frequency'
        db.alter_column(u'cabotapp_statuscheck', 'frequency', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'TCPStatusCheck.timeout'
        db.alter_column(u'cabotapp_tcpstatuscheck', 'timeout', self.gf('cabot.cabotapp.fields.PositiveIntegerMaxField')())

        # Changing field 'JenkinsStatusCheck.max_queued_build_time'
        db.alter_column(u'cabotapp_jenkinsstatuscheck', 'max_queued_build_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Service.hipchat_room_id'
        db.alter_column(u'cabotapp_service', 'hipchat_room_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'GraphiteStatusCheck.interval'
        db.alter_column(u'cabotapp_graphitestatuscheck', 'interval', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GraphiteStatusCheck.expected_num_hosts'
        db.alter_column(u'cabotapp_graphitestatuscheck', 'expected_num_hosts', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GraphiteStatusCheck.expected_num_metrics'
        db.alter_column(u'cabotapp_graphitestatuscheck', 'expected_num_metrics', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'HttpStatusCheck.timeout'
        db.alter_column(u'cabotapp_httpstatuscheck', 'timeout', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'StatusCheck.retries'
        db.alter_column(u'cabotapp_statuscheck', 'retries', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'StatusCheck.frequency'
        db.alter_column(u'cabotapp_statuscheck', 'frequency', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'TCPStatusCheck.timeout'
        db.alter_column(u'cabotapp_tcpstatuscheck', 'timeout', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'JenkinsStatusCheck.max_queued_build_time'
        db.alter_column(u'cabotapp_jenkinsstatuscheck', 'max_queued_build_time', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Service.hipchat_room_id'
        db.alter_column(u'cabotapp_service', 'hipchat_room_id', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'cabotapp.graphitestatuscheck': {
            ...
            'expected_num_hosts': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True'}),
            'expected_num_metrics': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True'}),
