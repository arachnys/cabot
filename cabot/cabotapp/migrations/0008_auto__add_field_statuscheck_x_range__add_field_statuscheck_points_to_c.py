...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatusCheck.x_range'
        db.add_column(u'cabotapp_statuscheck', 'x_range',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'StatusCheck.points_to_check'
        db.add_column(u'cabotapp_statuscheck', 'points_to_check',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatusCheck.x_range'
        db.delete_column(u'cabotapp_statuscheck', 'x_range')

        # Deleting field 'StatusCheck.points_to_check'
        db.delete_column(u'cabotapp_statuscheck', 'points_to_check')
    ...
    models = {
        ...
        u'cabotapp.statuscheck': {
            ...
            'points_to_check': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            ...
            'x_range': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },
