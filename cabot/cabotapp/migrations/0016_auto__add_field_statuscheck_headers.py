...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatusCheck.headers'
        db.add_column(u'cabotapp_statuscheck', 'headers',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatusCheck.headers'
        db.delete_column(u'cabotapp_statuscheck', 'headers')
