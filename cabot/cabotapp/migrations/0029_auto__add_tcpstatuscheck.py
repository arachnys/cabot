...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TCPStatusCheck'
        db.create_table(u'cabotapp_tcpstatuscheck', (
            ...
            ('timeout', self.gf('django.db.models.fields.IntegerField')(default=8)),
        ))
        db.send_create_signal(u'cabotapp', ['TCPStatusCheck'])


    def backwards(self, orm):
        # Deleting model 'TCPStatusCheck'
        db.delete_table(u'cabotapp_tcpstatuscheck')
    ...
    models = {
        ...
        u'cabotapp.tcpstatuscheck': {
            ...
            u'statuscheck_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['cabotapp.StatusCheck']", 'unique': 'True', 'primary_key': 'True'}),
            'timeout': ('django.db.models.fields.IntegerField', [], {'default': '8'})
        },
