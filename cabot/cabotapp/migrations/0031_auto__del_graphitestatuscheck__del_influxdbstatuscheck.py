...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'cabotapp_graphitestatuscheck', (
            ...
            ('expected_num_hosts', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True)),
            ...
            ('expected_num_metrics', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True)),
        ))
