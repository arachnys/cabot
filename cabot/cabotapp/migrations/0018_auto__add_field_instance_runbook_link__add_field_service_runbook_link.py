...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.runbook_link'
        db.add_column(u'cabotapp_instance', 'runbook_link',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Service.runbook_link'
        db.add_column(u'cabotapp_service', 'runbook_link',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.runbook_link'
        db.delete_column(u'cabotapp_instance', 'runbook_link')

        # Deleting field 'Service.runbook_link'
        db.delete_column(u'cabotapp_service', 'runbook_link')
    ...
    models = {
        ...
        u'cabotapp.instance': {
            ...
            'runbook_link': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'cabotapp.statuscheckresult': {
            'Meta': {'ordering': "['-time_complete']", 'object_name': 'StatusCheckResult', 'index_together': "(('check', 'time_complete'), ('check', 'id'))"},
