...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'StatusCheck.debounce'
        db.rename_column(u'cabotapp_statuscheck', 'debounce', 'retries')

    def backwards(self, orm):
        # Renaming field 'StatusCheck.retries'
        db.rename_column(u'cabotapp_statuscheck', 'retries', 'debounce')
