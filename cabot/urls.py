...
urlpatterns = patterns('',
    ...
    url(r'^accounts/password-reset-confirm/',  view=password_reset_confirm,                name='password-reset-confirm'), # noqa
    ...
    url(r'^checks/report/$',                   view=StatusCheckReportView.as_view(),       name='checks-report'),
    url(r'^check/duplicate/(?P<pk>\d+)/',      view=duplicate_check,                       name='duplicate-check'),
    url(r'^influxdbcheck/create/',             view=InfluxDBCheckCreateView.as_view(),     name='create-influxdb-check'), # noqa
    url(r'^influxdbcheck/update/(?P<pk>\d+)/', view=InfluxDBCheckUpdateView.as_view(),     name='update-influxdb-check'), # noqa
    url(r'^graphitecheck/create/',             view=GraphiteCheckCreateView.as_view(),     name='create-graphite-check'), # noqa
    url(r'^graphitecheck/update/(?P<pk>\d+)/', view=GraphiteCheckUpdateView.as_view(),     name='update-graphite-check'), # noqa
    ...
    url(r'^tcpcheck/create/',                  view=TCPCheckCreateView.as_view(),          name='create-tcp-check'),
    url(r'^tcpcheck/update/(?P<pk>\d+)/',      view=TCPCheckUpdateView.as_view(),          name='update-tcp-check'),
    ...
    url(r'^user/(?P<pk>\d+)/profile/(?P<alerttype>.+)', view=UserProfileUpdateAlert.as_view(), name='update-alert-user-data'), # noqa
    ...
    url(r'^grafana/instance/$',                         view=GrafanaInstanceSelectView.as_view(),                  name='grafana-instance-select'),  # noqa
    url(r'^grafana/dashboard/$',                        view=GrafanaDashboardSelectView.as_view(),                 name='grafana-dashboard-select'), # noqa
    url(r'^grafana/panel/$',                            view=GrafanaPanelSelectView.as_view(),                     name='grafana-panel-select'),     # noqa
    url(r'^grafana/series/$',                           view=GrafanaSeriesSelectView.as_view(),                    name='grafana-series-select'),    # noqa
    url(r'^grafana/edit/(?P<pk>\d+)/',                  view=GrafanaEditView.as_view(),                            name='grafana-edit'),             # noqa
    url(r'^grafana/elasticsearch/create/$',             view=GrafanaElasticsearchStatusCheckCreateView.as_view(),  name='grafana-es-create'),        # noqa
    url(r'^grafana/elasticsearch/update/(?P<pk>\d+)/',  view=GrafanaElasticsearchStatusCheckUpdateView.as_view(),  name='grafana-es-update'),        # noqa
    url(r'^grafana/elasticsearch/refresh/(?P<pk>\d+)/', view=GrafanaElasticsearchStatusCheckRefreshView.as_view(), name='grafana-es-refresh'),       # noqa
    url(r'^grafana/refresh/(?P<pk>\d+)/',               view=GrafanaInstanceSelectView.as_view(),                  name='grafana-refresh'),          # noqa
    url(r'^grafana/dashboard/(?P<pk>\d+)/',             view=GrafanaDashboardSelectView.as_view(),                 name='grafana-dashboard-select'), # noqa
    url(r'^grafana/panel/(?P<pk>\d+)/',                 view=GrafanaPanelSelectView.as_view(),                     name='grafana-panel-select'),     # noqa
    url(r'^grafana/series/(?P<pk>\d+)/',                view=GrafanaSeriesSelectView.as_view(),                    name='grafana-series-select'),    # noqa
