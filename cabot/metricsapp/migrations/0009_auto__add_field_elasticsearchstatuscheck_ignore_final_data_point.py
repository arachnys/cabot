...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElasticsearchStatusCheck.ignore_final_data_point'
        db.add_column(u'metricsapp_elasticsearchstatuscheck', 'ignore_final_data_point',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElasticsearchStatusCheck.ignore_final_data_point'
        db.delete_column(u'metricsapp_elasticsearchstatuscheck', 'ignore_final_data_point')
