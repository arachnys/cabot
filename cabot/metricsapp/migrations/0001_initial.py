...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetricsSourceBase'
        db.create_table(u'metricsapp_metricssourcebase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
        ))
        db.send_create_signal('metricsapp', ['MetricsSourceBase'])

        # Adding model 'MetricsStatusCheckBase'
        db.create_table(u'metricsapp_metricsstatuscheckbase', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['metricsapp.MetricsSourceBase'])),
            ('check_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('warning_value', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('high_alert_importance', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=30)),
            ('high_alert_value', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('time_range', self.gf('django.db.models.fields.IntegerField')(default=30)),
        ))
        db.send_create_signal('metricsapp', ['MetricsStatusCheckBase'])


    def backwards(self, orm):
        # Deleting model 'MetricsSourceBase'
        db.delete_table(u'metricsapp_metricssourcebase')

        # Deleting model 'MetricsStatusCheckBase'
        db.delete_table(u'metricsapp_metricsstatuscheckbase')
