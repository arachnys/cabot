...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GrafanaPanel.panel_url'
        db.add_column(u'metricsapp_grafanapanel', 'panel_url',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GrafanaPanel.panel_url'
        db.delete_column(u'metricsapp_grafanapanel', 'panel_url')
