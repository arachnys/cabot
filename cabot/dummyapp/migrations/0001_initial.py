...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DummySource'
        db.create_table(u'dummyapp_dummysource', (
        ...
        db.send_create_signal('dummyapp', ['DummySource'])

        # Adding model 'DummyStatusCheck'
        db.create_table(u'dummyapp_dummystatuscheck', (
        ...
        db.send_create_signal('dummyapp', ['DummyStatusCheck'])


    def backwards(self, orm):
        # Deleting model 'DummySource'
        db.delete_table(u'dummyapp_dummysource')

        # Deleting model 'DummyStatusCheck'
        db.delete_table(u'dummyapp_dummystatuscheck')
