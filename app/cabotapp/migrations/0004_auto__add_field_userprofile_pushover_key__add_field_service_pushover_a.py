...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.pushover_key'
        db.add_column('cabotapp_userprofile', 'pushover_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Service.pushover_alert'
        db.add_column('cabotapp_service', 'pushover_alert',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.pushover_key'
        db.delete_column('cabotapp_userprofile', 'pushover_key')

        # Deleting field 'Service.pushover_alert'
        db.delete_column('cabotapp_service', 'pushover_alert')
    ...
    models = {
        ...
        'cabotapp.service': {
            ...
            'pushover_alert': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'cabotapp.userprofile': {
            ...
            'pushover_key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
